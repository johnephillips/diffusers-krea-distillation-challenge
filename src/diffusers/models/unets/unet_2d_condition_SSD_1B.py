...
@dataclass
class UNet2DConditionSSD1BOutput(BaseOutput):
    """
...
class UNet2DConditionModelSSD1B(
    ...
    shaped output. This is a smaller version of the original UNet2DConditionModel, meant to be trained using distllation
    from SDXL to create SSD-1B.
    ...
    ) -> Union[UNet2DConditionSSD1BOutput, Tuple]:
        r"""
